  ...
  <div class="row no-gutters">
    <div class="col-sm-5">
      <img
        ...
        src=" ${upcoming[index].image} "
        alt=""
      />
    </div>
    <div class="col-sm-7">
      <div class="card-body">
        <h5 class="card-title">${ upcoming[index].name } </h5>
        <p class="card-text">${ upcoming[index].description }</p>
        <p class="card-text">${ upcoming[index].date }</p>
        <p class="card-text">Price $ ${ upcoming[index].price }</p>
        <a href="./details.html?id=${ upcoming[index]._id}" class="btn btn-primary">Details</a>
      </div>
    </div>
  </div>
</div>
